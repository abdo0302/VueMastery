...
const Todos=()=>{
  store.commit('setMain','Todos')
}
const Posts=()=>{
  store.commit('setMain','Posts')
}
</script>
<template>
    ...
    <div class="flex flex-col justify-between h-full">
      <div class="flex-grow">
        ...
        <div class="p-4">
          <ul class="space-y-1">
            <li @click="Posts">
              <a href="javascript:void(0)" class="flex items-center  hover:bg-yellow-200 rounded-xl font-bold text-sm text-yellow-900 py-3 px-4">
            ...
            <li @click="Todos">
              <a href="javascript:void(0)" class="flex hover:bg-yellow-200 rounded-xl font-bold text-sm text-gray-900 py-3 px-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="text-lg mr-4" viewBox="0 0 16 16">
